...
const Main4 = () => {
  ...
  return (
    <section className="relative py-12 bg-[#F8F5F0]">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4 md:items-start">
          ...
          <div className="md:col-span-3">
            ...
            <div className="md:hidden">
              <Swiper
                modules={[Autoplay, Pagination]} // Added Autoplay, removed Navigation
                spaceBetween={16}
                slidesPerView={1.2}
                centeredSlides={true}
            ...
            <div className="hidden md:grid gap-6">
              ...
              <div className="grid grid-cols-3 gap-6">
                {opportunities.slice(2).map((item) => (
                  <div
                    key={item.id}
                    className="relative h-64 overflow-hidden" // Removed rounded-lg
                  >
                    <img
                      src={item.image}
                      alt={item.title}
          ...
          <div className="md:col-span-1 flex items-start">
            <div className="max-w-md md:pl-8 text-center md:text-left">
              {" "}
              {/* Centered text for mobile */}
              <h2 className="hidden md:block font-play text-4xl font-bold text-gray-900 leading-tight mb-6 text-start">
                {" "}
                {/* Centered text */}
                Areas of Opportunity
              </h2>
